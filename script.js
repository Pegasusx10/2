    ...
    for(let count=0;count<number_of_flights;count++){
        ...
        <div class="card" >
            <div class="card-body">
                ...
                <a href="form.html"><button type="button" class="btn btn-primary" id="flight${flight_det[count]['id']}" onclick="location.href='booking.html'; get_flight_details(${flight_det[count]['id']});" >Proceed</button></a>
